    ...
    <div className="flex flex-col items-center space-y-6 opacity-0 animate-fade-up" style={{"--delay": "1"} as React.CSSProperties}>
      <div className="photo-border">
        <div className="h-48 w-48 rounded-tl-3xl rounded-br-3xl overflow-hidden relative z-10">
          <img
            src="/lovable-uploads/39bb1463-a11b-452a-8b91-723dcb4c2c24.png"
            alt="Andreu Bustos"
      ...
      <div className="space-y-3 mt-4 max-w-xs">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span>andreu@gmail.com</span>
        </div>
        
        <div className="flex items-center space-x-2">
          <Github className="h-4 w-4 text-gold-500" />
          <a href="https://github.com/andreubustos" className="hover:text-gold-500 transition-colors">github.com/andreubustos</a>
        </div>
        
        <div className="flex items-center space-x-2">
          <Linkedin className="h-4 w-4 text-gold-500" />
          <a href="https://linkedin.com/in/a-e5538278/" className="hover:text-gold-500 transition-colors">linkedin.com/in/a-e5538278/</a>
        </div>
      </div>
